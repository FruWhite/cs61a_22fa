...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    all_dices = [dice() for i in range(0, num_rolls)]
    for n in all_dices:
        if n == 1:
            return 1
...
def run_experiments():
    ...
    print('final_strategy VS square_strategy win rate:', average_win_rate(final_strategy, square_strategy))
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if perfect_square(score + 1) and score >= 8 and next_perfect_square(score + 1) >= square_update(0, score, opponent_score):
        return 10
    elif square_update(0, score, opponent_score) - score > 8 or square_update(0, score, opponent_score) >= GOAL:
        return 0
    elif score >= 90:
        return 4
    else:
